...
# CSV
rio_csv <- import("/Users/borja/Desktop/ImportingData_Datasets/mbb.csv")
head(rio_csv)

# TXT
rio_txt <- import("/Users/borja/Desktop/ImportingData_Datasets/mbb.txt")
head(rio_txt)

# Excel XLSX
rio_xlsx <- import("/Users/borja/Desktop/ImportingData_Datasets/mbb.xlsx")
head(rio_xlsx)
...
# complete data.
r_txt1 <- read.table("/Users/borja/Desktop/ImportingData_Datasets/mbb.txt", header = TRUE)

# This works with missing data by specifying the separator: 
# \t is for tabs, sep = "," for commas. R converts missing
# to "NA"
r_txt2 <- read.table("/Users/borja/Desktop/ImportingData_Datasets/mbb.txt", 
  header = TRUE, 
  sep = "\t")
